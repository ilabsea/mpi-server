...
<div class="row-fluid input-row">
   ...
   <div class="span9"><input type="password" name="user_pwd" value=""></div>
</div>

<div class="row-fluid input-row">
  <div class="span3">New Password*</div>
   <div class="span9"><input type="password" name="user_new_pwd" value=""></div>
</div>

<div class="row-fluid input-row">
  <div class="span3">Password Confirmation*</div>
   <div class="span9"><input type="password" name="user_confirm_pwd" value=""></div>
</div>
...
<div class="row-fluid">
  ...
  <div class="span9">
    ...
    <a href='<?=site_url("main")?>' class="btn btn-danger"> Cancel </a>
  </div>
</div>
