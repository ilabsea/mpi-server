...
<div class='item-nav-group'>
  <a href='<?=AppHelper::url(array("type" => "list")) ?>' class='item-nav <?= $params['type'] != 'graph' ? 'active' : ''  ?>'>
    <i class="icon icon-th"></i>
  </a>

  <a href='<?=AppHelper::url(array("type" => "graph")) ?>'  class='item-nav <?= $params['type'] == 'graph' ? 'active' : ''  ?>'>
